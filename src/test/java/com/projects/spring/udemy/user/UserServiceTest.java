...
//        Course mockC2 = mock(Course.class);
//        Set<Course> likedCourses = Set.of(mockC1, mockC2);
//        // mocked user
//        User mockUser = mock(User.class);
//        when(mockUser.getLikedCourses()).thenReturn(likedCourses);
//        // mocked UserService to call already checked findUserById method
//        // FIXME: Can I use mocked object if I test class of this object ?
//        UserService mockUserService = mock(UserService.class);
//        when(mockUserService.findUserById(anyInt())).thenReturn(mockUser);
//        // system under test
////        var toTest = new UserService
//                // when
//        var result = toTest.findUserById(1);
//        // then
//        assertThat(result.getName()).isEqualTo(userName);
